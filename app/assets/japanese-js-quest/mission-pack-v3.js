  ...
  function conditionalDragonBossMission () {
    ...
    return {
      ...
      instructions: [
        ...
        '10回以内の移動で宝石を取り、上のゴールへたどり着きましょう。',
      ],
      api: [
        'hero.readSign()',
        'hero.move("up")',
      ...
      hints: [
        ...
        '安全な列に入ったら、そのまま上へ7マス進むと、宝石を取ってゴールへ着きます。',
      ],
      solution,
      variants: [
        {
      ...
      victoryConditions: [
        { id: 'max-moves', label: '移動：最大 10 回' },
      ],
      requirements: {
        state: { goal: true, minGems: 1, maxMoves: 10, noDragonFire: true },
        syntax: [
