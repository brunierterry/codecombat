...
assert.strictEqual(version, '0.3.10')
...
assert(!intro.includes("姿なら: 'すがたなら'"), 'The reading tooltip must target 姿 only, not 姿なら')
...
console.log('Validated seven directly loaded high-quality PNG story pages, 姿-only reading, back navigation, MISSION 00 replay behavior and app version 0.3.10.')
