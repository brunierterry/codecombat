...
assert.strictEqual(version, '0.3.8')
...
console.log('Validated seven directly loaded high-quality PNG story pages, readings, back navigation, MISSION 00 replay behavior and app version 0.3.8.')
